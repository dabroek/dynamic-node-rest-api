...
mongoose.connect('mongodb://localhost/rest-resources'); // connect to database
...
function validateResource (req, res, next) {
    fs.readFile('./rest-resources.json', { encoding: 'utf8' }, function (err, data) {
    ...
    .post(function(req, res) {
        ...
        item.save(function(err) {
            if (err) 
                ...
                res.json({ message: req.resource.modelName + ' created' });
        });
    })
            ...
            if (err) 
                ...
                item.save(function(err) {
                    if (err) 
                        ...
                        res.json({ message: req.resource.modelName + ' updated' });
                });
            }
        });
    })
    ...
    .delete(function(req, res) {
        req.resource.remove({
            ...
            if (err) 
                ...
                res.json({ message: req.resource.modelName + ' deleted' });
        });
    });
